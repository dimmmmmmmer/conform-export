...
- **Versions and platforms:** needs DaVinci Resolve Studio 19 or later; tested with Resolve Studio 21 on macOS. Windows and Linux are covered by automated tests only. Reports from other setups are welcome.
